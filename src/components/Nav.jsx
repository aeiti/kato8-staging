 ...
 *
 * Two bars:
 *   - The main tall wavy header (in-flow at the top): logo, Games dropdown, a
 *     Crowdfunding link (to the `/crowdfunding-games` landing), About, socials
 *     on desktop; hamburger → MobileMenu on mobile.
